...
{
    // ═══════════════════════════════════════════════════════════════════
    //  FIX 1+5+RUSH — TeleportToShrine intercepté
    // ═══════════════════════════════════════════════════════════════════
    ...
    public static class TeleportToShrinePatch
    {
        ...
        public static bool Prefix()
        {
            ...
            {
                // If this teleport was triggered by a player death, skip OnBossDefeated
                if (BossRushModeManager.IsDeathTeleport)
                {
                    BossRushModeManager.IsDeathTeleport = false;
                    return true;
                }
