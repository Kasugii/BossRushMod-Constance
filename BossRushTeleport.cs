...
namespace BossRushMod
{
    public static class BossRushTeleporter
    {
            ...
            new Dictionary<string, string>
        {
            ...
            // Astral Academy
            { "MothQueen",     "cp_Prod_A27_d8bfef9c-93f6-4070-b97d-249aa31a9f65" }, // TODO — capture from logs
            { "AweKing",        "cp_Prod_A16_08a800e0-9b00-11ef-b44d-37183fa010d2" }, // TODO

            // Chaotic Carnival
            { "CornelisBoss",    "cp_Prod_C01_19000030-5e50-11f0-a46c-1527a3f3d92d" }, // TODO
            { "Joker",          "cp_Prod_C90_28acb3c0-9b00-11ef-a184-31489395bef3" }, // TODO
            { "JugglerBalloons",    "cp_Prod_C95_e2cd59fe-b91b-a9df-1e24-ef3fb9769ef6" }, // TODO
            { "JugglerBalls",   "cp_Prod_C96_a078dfb0-ac70-11f0-a362-1d051cf4bcbd" }, // TODO
            { "JokerInvisible",  "cp_Prod_C94_1c19a550-fa90-11f0-8eec-7fe86f49a79f" }, // TODO

            // Vanishing Vaults
            { "SlimeNemesis", "cp_Prod_V11_903743d6-88da-c870-37db-53ab0e9b2d7d" }, // TODO
            { "PukeyBoy",     "cp_Prod_V18_e0305230-e920-11ef-8aab-13dfc45c483b" }, // TODO

            // Voids
            { "PuppetHandStrings",    "cp_Prod_VD03_8c4d3f70-8560-11f0-9198-09c6ccf99122" }, // TODO
            { "PuppetHandCorruption", "cp_Prod_VD01_522feda0-73f0-11ef-91d7-1d5ddf16a67a" }, // TODO
            { "PuppetHandKungfu",     "cp_Prod_VD02_55009bd0-1030-11f0-8fef-01507257725f" }, // TODO
            { "PuppetMaster",         "cp_Prod_VD02_55009bd0-1030-11f0-8fef-01507257725f" }, // TODO
        };
        ...
        public static bool TeleportToBoss(string bossId, bool forceReload = false)
        {
            ...
            var cmd = new ConTransitionCommand_Default(
                ...
                false,
                ConRespawnOrigin.Undefined,
                null,
                default(ConCheckPointId),
                null
            );
